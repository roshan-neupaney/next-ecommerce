...
const Functions = () => {
  ...
  return (
   ...
   <div className="quantityBox flex my-4 h-8">
        ...
        <button className='w-8  border-2 border-solid' 
        ...
        <div className="addtoCartBox  ml-2">
          <button className='bg-[#413E65] flex justify-center items-center text-white w-80 border-2 border-solid h-8 hover:bg-[#F25C54]' 
          onClick={tickOnclick}
           >Add To Cart <div className='mx-1 text-base font-bold'>
            {tick}
            </div></button>
        </div>
        </div>
